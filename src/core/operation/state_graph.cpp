...
fluid::StateGraph::StateGraph() : Graph() {
    ...
    // Set up the graph
    std::shared_ptr<fluid::Identifiable> init_state = std::make_shared<fluid::InitState>();
    std::shared_ptr<fluid::Identifiable> idle_state = std::make_shared<fluid::IdleState>();
    std::shared_ptr<fluid::Identifiable> take_off_state = std::make_shared<fluid::TakeOffState>();
